...
var translations = map[Locale]map[string]string{
	Zh: {
		...
		"bottom.navigate":             "j/k 导航",
		"bottom.action":               "Enter 执行",
		...
		"add_file.path_invalid":       "x 路径不可达",
		"add_file.hint":               "  Tab/Up/Down 下一项 · Enter 确认 · ctrl+y 复制 · ctrl+u 清空 · Esc 返回 · 也可直接拖入文件",
		...
		// ── Edit file view ────────────────────────────────────────────────────
		"edit_file.title": " [EDIT] 编辑文件",
		"edit_file.hint":  "  Tab/Up/Down 下一项 · Enter 确认 · ctrl+y 复制 · ctrl+u 清空路径并解除关联 · Esc 返回",
		"edit_file.saved": "「%s」编辑已保存",

		// ── Set directory view ────────────────────────────────────────────────
		"set_dir.title":           " [DIR] 设置本地目录",
		"set_dir.label":           "路径",
		...
		"settings.hint":                  "  Tab/Up/Down 下一项 · Enter 保存 · t 测试 · p 密码 · ctrl+b 导出 · ctrl+y 复制 · ctrl+u 清空 · Esc 返回",
		...
		"sync.result.uploaded":      "UP 上传 %d",
		"sync.result.downloaded":    "DN 下载 %d",
		"sync.result.skipped":       "– 跳过 %d",
		"sync.result.failed":        "x 失败 %d",
		"sync.result.unbound":       "o 未关联 %d",
		...
		"confirm.hint_close": "Tab / h / l 选择 · Enter 确认 · Esc 取消",
		...
		"update.confirm_title":         "更新到 %s（当前 %s）",
		"update.action":                "更新",
		"update.downloading":           "正在下载更新...",
		"update.success":               "更新成功",
		"update.restart_hint":          "新版本已就绪，请重启应用以使用新版本",
		"update.failed":                "更新失败: %s",
		"update.brew_hint":             "Homebrew 版本可更新：%s → %s，按 U 升级",
		"update.brew_confirm":          "将通过 Homebrew 升级；执行期间终端会显示命令输出。",
		"update.brew_action":           "Homebrew 升级",
		"update.elevation_hint":        "安装目录需要管理员权限；下载完成后将由 sudo 请求密码。",
	...
	En: {
		...
		"bottom.auto_sync":            "auto %ds · %s",
		"bottom.navigate":             "j/k Nav",
		"bottom.action":               "Enter Action",
		...
		"add_file.path_valid":         "+ %s  %s",
		"add_file.path_invalid":       "x Path not accessible",
		"add_file.hint":               "  Tab/Up/Down Next · Enter Confirm · ctrl+y Copy · ctrl+u Clear · Esc Back · Or drag a file in",
		...
		// ── Edit file view ────────────────────────────────────────────────────
		"edit_file.title": " [EDIT] Edit File",
		"edit_file.hint":  "  Tab/Up/Down Next · Enter Confirm · ctrl+y Copy · ctrl+u Clear path to unlink · Esc Back",
		"edit_file.saved": "\"%s\" saved",

		// ── Set directory view ────────────────────────────────────────────────
		"set_dir.title":           " [DIR] Set Local Directory",
		"set_dir.label":           "Path",
		...
		// ── Settings view ───────────────────────────────────────────────────
		"settings.title":                 " [SET] Storage Settings",
		...
		"settings.hint":                  "  Tab/Up/Down Next · Enter Save · t Test · p Password · ctrl+b Export · ctrl+y Copy · ctrl+u Clear · Esc Back",
		...
		"sync.result.uploaded":      "UP Uploaded %d",
		"sync.result.downloaded":    "DN Downloaded %d",
		"sync.result.skipped":       "– Skipped %d",
		"sync.result.failed":        "x Failed %d",
		"sync.result.unbound":       "o Unbound %d",
		...
		// ── Help ────────────────────────────────────────────────────────────
		"help.title":              " [KEYS] Keyboard Shortcuts",
		"help.nav":                "Navigation",
		"help.nav.up":             "Up / k  Up",
		"help.nav.down":           "Down / j  Down",
		...
		"confirm.hint_close": "Tab / h / l Select · Enter Confirm · Esc Cancel",
		...
		"update.confirm_title":         "Update to %s (current: %s)",
		...
		"update.brew_hint":             "Homebrew update available: %s → %s. Press U to upgrade",
		"update.brew_confirm":          "Homebrew will perform the upgrade and show its output in this terminal.",
		"update.brew_action":           "Upgrade with brew",
		"update.elevation_hint":        "The install directory requires administrator access. sudo will request your password after download.",
